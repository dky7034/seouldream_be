...
public class AttendanceService {
    ...
    public SubmittedDatesDto getSubmittedDates(Long cellId, Long semesterId) {
        ...
        if (semesterId != null) {
            ...
            dates = attendanceRepository.findDistinctDatesByCellIdAndDateBetween(cellId, semester.startDate(), semester.endDate());

        } else {

            dates = attendanceRepository.findDistinctDatesByCellId(cellId);
        ...
        return new SubmittedDatesDto(dateStrings);
